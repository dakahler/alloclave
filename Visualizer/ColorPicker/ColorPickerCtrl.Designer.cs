namespace Alloclave
{
	partial class ColorPickerCtrl
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_colorSample = new Alloclave.LabelRotate();
			this.m_infoLabel = new Alloclave.LabelRotate();
			this.m_colorTable = new Alloclave.ColorTable();
			this.m_eyedropColorPicker = new Alloclave.EyedropColorPicker();
			this.m_colorWheel = new Alloclave.ColorWheelCtrl();
			this.m_opacitySlider = new Alloclave.ColorSlider();
			...
			this.m_opacitySlider.NumberOfColors = Alloclave.ColorSlider.eNumberOfColors.Use2Colors;
			...
			this.m_opacitySlider.ValueOrientation = Alloclave.ColorSlider.eValueOrientation.MinToMax;
			// 
			// ColorPickerCtrl
			// 
