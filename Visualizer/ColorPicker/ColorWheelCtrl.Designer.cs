namespace Alloclave
{
	partial class ColorWheelCtrl
	{
		...
		{
			this.m_colorWheel = new Alloclave.ColorWheel();
			this.m_colorBar = new Alloclave.HSLColorSlider();
			this.SuspendLayout();
			// 
			// m_colorWheel
			// 
			...
			this.m_colorBar.ValueOrientation = Alloclave.ColorSlider.eValueOrientation.MinToMax;
			// 
			// ColorWheelCtrl
			// 
