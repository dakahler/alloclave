...
class SourceInfo:
	def __init__(self, baseDir , outputDir, outputName):
		...
		self.AddSourceDirectory(self.baseDir)
	...
	def InitAmalgamationStreams(self):
		...
		copyrightText = ("// Copyright Circular Shift.\n"
		...
		self.headerAmalgamation.write(copyrightText)
		self.sourceAmalgamation.write(copyrightText)
	...
	def WriteEndFileHeader(self, filename, stream):
		stream.write("\n\n\n")
		stream.write("// End File: " +  os.path.basename(filename))
		stream.write("\n\n\n")
